...
public class ExpenseTrackerAppServiceImpl implements ExpenseTrackerAppService {
    ...
    public void addIncome(AddIncomeRequest addIncomeRequest) {
        ...
        Income income = incomeService.addIncome(addIncomeRequest.getIncomeCategoryName(), addIncomeRequest.getAmount(), expensesTrackerApp.getId());
    ...
    public void addExpenses(AddExpenseRequest addExpenseRequest) {
        ...
        Expense expense = expenseService.addExpenses(addExpenseRequest.getExpenseCategoryName(), addExpenseRequest.getAmount(), expensesTrackerApp.getId());
